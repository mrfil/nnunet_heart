...
class MyApp(MONAILabelApp):
    def __init__(self, app_dir, studies, conf):
        ...
        super().__init__(
            ...
            studies=studies,
            conf=conf,
            name=f"MONAILabel - nnunet_heart ({monailabel.__version__})",
            description="nnUNet for heart",
...
def main():
    ...
    home = str(Path.home())
    studies = f"{home}/Dataset/nnunet_heart"

    parser = argparse.ArgumentParser()
    parser.add_argument("-s", "--studies", default=studies)
    parser.add_argument("-m", "--model", default="nnunet")
